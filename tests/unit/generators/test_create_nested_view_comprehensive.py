...
class TestCreateNestedViewComprehensive:
    ...
    def test_create_nested_view_basic_functionality(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
        """Test basic nested view creation functionality."""
        # Setup
        mock_dimension_generator.lookml_dimensions_from_model.return_value = ([{'name': 'test_dim', 'type': 'string'}], {})
        ...
        with patch.object(ColumnCollections, 'from_model') as mock_from_model:
            ...
            result = view_generator._create_nested_view(
                mock_model, "base", mock_array_model, "Test Label", mock_dimension_generator, mock_measure_generator
            )
    ...
    def test_create_nested_view_with_use_table_name(
        self, mock_cli_args, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
        ...
        mock_dimension_generator.lookml_dimensions_from_model.return_value = ([{'name': 'test_dim'}], {})
    ...
    def test_create_nested_view_with_dimension_groups(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
        ...
        mock_dimension_generator._clean_dimension_groups_for_output.return_value = [{'name': 'created', 'type': 'time'}]
    ...
    def test_create_nested_view_with_measures(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
        """Test nested view creation with measures."""
        mock_dimension_generator.lookml_dimensions_from_model.return_value = ([], {})
        mock_measure_generator.lookml_measures_from_model.return_value = [{'name': 'count', 'type': 'count'}]
    ...
    def test_create_nested_view_with_conflicting_dimensions(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
        ...
        mock_dimension_generator._comment_conflicting_dimensions.return_value = ([{'name': 'test_dim'}], ['conflicting_dim'])
        mock_dimension_generator._clean_dimension_groups_for_output.return_value = [{'name': 'created', 'type': 'time'}]
    ...
    def test_create_nested_view_returns_none_for_empty_view(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_nested_view_with_array_models_none(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_nested_view_caching_behavior(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_nested_view_with_complex_array_models(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_nested_view_name_generation_edge_cases(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_nested_view_dimension_groups_cleaning(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_nested_view_measures_with_walrus_operator(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
        """Test measures assignment using walrus operator."""
        mock_dimension_generator.lookml_dimensions_from_model.return_value = ([], {})
        mock_measure_generator.lookml_measures_from_model.return_value = [{'name': 'total_amount', 'type': 'sum'}]
    ...
    def test_create_nested_view_no_conflicting_dimensions_when_no_dimension_groups(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_nested_view_multiple_conflicting_dimensions(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_nested_view_cache_key_generation(
        self, view_generator, mock_model, mock_array_model, mock_dimension_generator, mock_measure_generator
    ):
