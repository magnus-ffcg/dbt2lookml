...
def mock_dimension_generator():
    ...
    generator = Mock()
    generator.lookml_dimensions_from_model.return_value = ([{"name": "id", "type": "string"}], [])  # nested dimensions
    generator.lookml_dimension_groups_from_model.return_value = {'dimension_groups': [], 'dimension_sets': []}
    generator._comment_conflicting_dimensions.return_value = ([{"name": "id", "type": "string"}], [])  # conflicting dimensions
...
class TestLookmlViewGenerator:
    ...
    def test_create_main_view_with_nested_dimensions(
        self, cli_args, sample_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_main_view_with_dimension_groups(
        self, cli_args, sample_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_main_view_with_conflicting_dimensions(
        self, cli_args, sample_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_main_view_no_dimensions(self, cli_args, sample_model, mock_measure_generator):
        ...
        mock_dimension_generator.lookml_dimension_groups_from_model.return_value = {'dimension_groups': [], 'dimension_sets': []}
    ...
    def test_create_main_view_with_empty_nested_dimensions(
        self, cli_args, sample_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_main_view_case_insensitive_name(
        self, cli_args, sample_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_create_nested_view_with_complex_array_model(
        self, cli_args, sample_model, mock_dimension_generator, mock_measure_generator
    ):
    ...
    def test_generate_integration(self, cli_args, sample_model):
        ...
        # Mock dimension and measure generators
        mock_dim_gen = Mock()
        mock_dim_gen.lookml_dimensions_from_model.return_value = ([{"name": "id", "type": "string"}], [])
        mock_dim_gen.lookml_dimension_groups_from_model.return_value = {'dimension_groups': [], 'dimension_sets': []}
