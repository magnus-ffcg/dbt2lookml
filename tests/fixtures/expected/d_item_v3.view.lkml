...
explore: d_item_v3 {
  label: "Conlaybi Item Versioned  D Item"
  from: d_item_v3
  hidden: no
  ...
  join: d_item_v3__packaging_information__packaging_material_composition {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${d_item_v3.packaging_material_composition}) AS d_item_v3__packaging_information__packaging_material_composition ;;
    type: left_outer
    required_joins: []
  }
  ...
  join: d_item_v3__packaging_information__packaging_material_composition__packaging_material_composition_quantity {
    relationship: one_to_many
    sql: LEFT JOIN UNNEST(${d_item_v3.packaging_material_composition_quantity}) AS d_item_v3__packaging_information__packaging_material_composition__packaging_material_composition_quantity ;;
    type: left_outer
    required_joins: []
  }
