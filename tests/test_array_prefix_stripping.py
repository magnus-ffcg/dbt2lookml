...
class TestArrayPrefixStripping:
    ...
    def test_format_period_enddate_stripping(self):
        ...
        column = MockColumn(name='format.period.enddate', original_name='Format.Period.EndDate', data_type='DATE')

        result = get_column_name(column=column, table_format_sql=True, is_nested_view=True, array_model_name='format')
    ...
    def test_simple_array_field_stripping(self):
        ...
        column = MockColumn(name='format.formatid', original_name='Format.FormatId', data_type='STRING')
    ...
    def test_case_insensitive_matching(self):
        ...
        column = MockColumn(
            name='supplierinformation.gtin.gtinid', original_name='SupplierInformation.GTIN.GTINId', data_type='STRING'
        )

        result = get_column_name(
            column=column, table_format_sql=True, is_nested_view=True, array_model_name='supplierinformation'
        )
    ...
    def test_no_prefix_when_not_matching(self):
        ...
        column = MockColumn(name='other.field.name', original_name='Other.Field.Name', data_type='STRING')
